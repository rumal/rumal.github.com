...
(function($){
  $.fn.extend({
    ...
    socialProfiles: function(options) {
      ...
      var beforeDivs = '<div class="arthref arthrefSocialProfiles"><div class="overlay '+options.animation+'"><div class="social-container"><div class="centered"><ul>';
      ...
      if(options.youtube) { listItem += '<li><a href="http://youtube.com/channel/'+options.youtube+'" target="_blank" rel="nofollow" class="aYouTube"><span></span></a><span>YouTube</span></li>'; }
      ...
      if(options.blogger) { listItem += '<li><a href="http://'+options.blogger+'" target="_blank" rel="nofollow" class="aBlogger"><span></span></a><span>Blogger</span></li>'; }
